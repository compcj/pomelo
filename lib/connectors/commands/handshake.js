...
var Command = function(opts) {
  ...
  this.cryptoHandshake = opts.cryptoHandshake;
  ...
  this.requireClientDict = opts.requireClientDict;
  this.requireClientProto = opts.requireClientProto;
...
Command.prototype.handle = function(socket, msg) {
  ...
  if(this.useCrypto) {
    if (typeof this.cryptoHandshake === 'function') {
      this.cryptoHandshake(msg, function(err, resp) {
        if(err) {
          process.nextTick(function() {
